...
const pairs = [
  ...
  ["Choose a district, locality, driving range, and mood—then reveal one of more than 60 sourced Portuguese destinations.", "Escolha um distrito, localidade, alcance e ambiente — e descubra um de mais de 60 destinos portugueses com fontes."],
  ...
  ["Choose a Portuguese district and locality, a comfortable distance, and a mood. The roulette selects from more than 60 destinations researched across official tourism pages, independent travel guides, and community recommendations. Every result explains why it matched and links to its inspiration source before handing the exact route to Google Maps.", "Escolha um distrito e localidade de Portugal, uma distância confortável e um ambiente. A roleta seleciona entre mais de 60 destinos pesquisados em turismo oficial, guias independentes e recomendações da comunidade. Cada resultado explica a escolha, liga à fonte de inspiração e abre a rota exata no Google Maps."],
  ["More than 60 sourced Portuguese destinations", "Mais de 60 destinos portugueses com fontes"],
  ...
  ["More than 60 sourced ideas", "Mais de 60 ideias com fontes"],
  ["Cost", "Custo"],
