...
const pairs = [
  ...
  ["8 apps · No installation", "8 apps · Sem instalação"],
  ...
  ["Private workout organiser", "Organizador privado de treinos"],
  ...
  ["Create sports, workouts, and flexible exercises with local images and videos—all kept on your device.", "Crie desportos, treinos e exercícios flexíveis com imagens e vídeos locais — tudo guardado no seu dispositivo."],
  ["Create sports and workouts, then organise every session by week and day in a private calendar.", "Crie desportos e treinos e organize cada sessão por semana e dia num calendário privado."],
  ["Open Fair Share details", "Abrir detalhes da Fair Share"],
  ["Open Media Inspector details", "Abrir detalhes do Media Inspector"],
  ["Open Training Atlas details", "Abrir detalhes do Training Atlas"],
  ...
  ["Private workout organiser · Web app", "Organizador privado de treinos · Web app"],
  ["Private training, meal, supplement, and progress organiser · Web app", "Organizador privado de treinos, refeições, suplementos e progresso · Web app"],
  ["Build any kind of training plan, organise meals and supplements, track fully custom personal progress, and safely compare saved backups.", "Crie qualquer tipo de plano de treino, organize refeições e suplementos, acompanhe um progresso pessoal totalmente personalizável e compare cópias guardadas em segurança."],
  ["Build any kind of training plan and keep every instruction, image, and video together.", "Crie qualquer tipo de plano de treino e mantenha todas as instruções, imagens e vídeos no mesmo lugar."],
  ["Build any kind of training plan, schedule it by week and day, and keep every instruction, image, and video together.", "Crie qualquer tipo de plano de treino, agende-o por semana e dia e mantenha todas as instruções, imagens e vídeos no mesmo lugar."],
  ["Open organiser", "Abrir organizador"],
  ["Every sport.", "Todos os desportos."],
  ["One clear plan.", "Um plano claro."],
  ["Create sports, add as many workouts as you need, and organise flexible exercises in the exact order you will perform them. Use structured fields when they help, or simply write the exercise in your own words.", "Crie desportos, adicione os treinos de que precisa e organize exercícios flexíveis pela ordem exata de execução. Utilize campos estruturados quando forem úteis ou escreva simplesmente o exercício pelas suas palavras."],
  ...
  ["Create sports, add as many workouts as you need, organise flexible exercises, reusable meals, and supplements, then schedule all three on specific days. Goals and a simple, fully custom progress profile stay together with the calendar.", "Crie desportos, adicione os treinos de que precisa, organize exercícios flexíveis, refeições reutilizáveis e suplementos e agende os três em dias específicos. Os objetivos e um perfil de progresso simples e totalmente personalizável ficam reunidos com o calendário."],
  ...
  ["Recoverable trash with linked items", "Reciclagem recuperável com elementos associados"],
  ["Free-form descriptions and optional fields", "Descrições livres e campos opcionais"],
  ["Duplicate and reorder controls", "Controlos para duplicar e reordenar"],
  ["Local images and videos", "Imagens e vídeos locais"],
  ...
  ["Delete only a profile or selected app sections", "Eliminar apenas um perfil ou secções selecionadas da app"],
  ...
  ["Plans and media are stored only in this browser on this device. Nothing is uploaded, no account is required, and the app makes no external requests.", "Os planos e ficheiros multimédia são guardados apenas neste navegador e dispositivo. Nada é enviado, não é necessária uma conta e a app não faz pedidos externos."],
  ["Plans, calendar entries, and media are stored only in this browser on this device. Nothing is uploaded, no account is required, and the app makes no external requests.", "Os planos, agendamentos e ficheiros multimédia são guardados apenas neste navegador e dispositivo. Nada é enviado, não é necessária uma conta e a app não faz pedidos externos."],
  ["Plans, calendar entries, deleted items, and media are stored only in this browser on this device. Nothing is uploaded, no account is required, and the app makes no external requests.", "Os planos, agendamentos, elementos eliminados e ficheiros multimédia são guardados apenas neste navegador e dispositivo. Nada é enviado, não é necessária uma conta e a app não faz pedidos externos."],
  ["Storage", "Armazenamento"],
  ["Planning", "Planeamento"],
  ["Week and month", "Semana e mês"],
  ["Recovery", "Recuperação"],
  ["Dependency-aware trash", "Reciclagem com dependências"],
  ["Images and videos", "Imagens e vídeos"],
  ["Sports", "Desportos"],
  ["Any discipline", "Qualquer modalidade"],
  ["Progress", "Progresso"],
  ["Optional and fully custom", "Opcional e totalmente personalizável"],
  ["Backup comparison", "Comparação de cópias"],
  ["Two snapshots, no automatic import", "Dois registos, sem importação automática"],
  ["Data controls", "Controlos de dados"],
  ["Profile-only or selected sections", "Apenas o perfil ou secções selecionadas"],
  ["Browser storage limits vary by device. Export a backup before clearing browser data.", "Os limites de armazenamento variam conforme o dispositivo. Exporte uma cópia antes de limpar os dados do navegador."],
  ...
  ["Allin1APP, Foculume, MacroAPP, Pixevra, Halvynox, Vehicle Cost Calculator, Home Energy Calculator, Road Trip Roulette, Map Link Switcher, GTA Online Timer Reference, Fair Share, Media Inspector, Training Atlas, their official icons, and their original product identities are presented as applications belonging to the EstrelaLuaApps collection. Their individual repositories or information pages may contain additional usage-rights notices.", "Allin1APP, Foculume, MacroAPP, Pixevra, Halvynox, Vehicle Cost Calculator, Home Energy Calculator, Road Trip Roulette, Map Link Switcher, GTA Online Timer Reference, Fair Share, Media Inspector e Training Atlas, os respetivos ícones oficiais e identidades originais são apresentados como aplicações da coleção EstrelaLuaApps. Os repositórios ou páginas individuais podem conter avisos adicionais sobre direitos de utilização."],
...
const pageMeta = {
  ...
  "/training-atlas.html": { en: ["Training Atlas — EstrelaLuaApps", "Create sports and workouts, then organise every session by week and day in a private local calendar."], pt: ["Training Atlas — EstrelaLuaApps", "Crie desportos e treinos e organize cada sessão por semana e dia num calendário privado e local."] },
};
