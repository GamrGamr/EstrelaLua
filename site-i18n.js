...
const pairs = [
  ...
  ["TheFork search for restaurant and café ideas", "Pesquisa no TheFork para sugestões de restaurantes e cafés"],
  ["English and Portuguese interface", "Interface em inglês e português"],
  ["Surprise without surveillance", "Surpresa sem vigilância"],
  ["The roulette does not request your GPS location. Choose a district and locality manually; saved trips stay in the current browser. Google receives public place names only when you open directions or a suggested stop. TheFork opens only when you choose a food search.", "A roleta não pede a localização GPS. Escolha manualmente um distrito e uma localidade; as viagens guardadas ficam no navegador atual. A Google só recebe nomes públicos de locais quando abre direções ou uma paragem sugerida. O TheFork só abre quando escolhe uma pesquisa de comida."],
  ["Coverage", "Cobertura"],
