...
const translations = {
  en: {
    ...
    progress: "Progress", personalProgress: "Personal progress", progressIntro: "Keep the basics simple, add only the measurements that matter to you, and compare saved backups without replacing anything.", profile: "Profile", basics: "Basics", editProfile: "Edit profile", profileOptionalCopy: "Everything is optional and remains only on this device.", nicknameOptional: "Name or nickname (optional)", heightOptional: "Height (optional)", weightOptional: "Weight (optional)", unit: "Unit", saveProfile: "Save profile", profileSaved: "Profile saved.", profileNotSet: "Add only the basic information you want to keep here.", notSet: "Not set", lastUpdated: "Last updated", fullyCustom: "Fully custom", myMeasurements: "My measurements", newMeasurement: "New measurement", addMeasurement: "Add measurement", addFirstMeasurement: "Add first measurement", noMeasurements: "No measurements yet", noMeasurementsCopy: "Add anything useful to you, such as weight, waist, 5K time, swimming pace, or maximum push-ups.", measurement: "Measurement", measurementDialogCopy: "Use any name, value, and unit that make sense for your sport or routine.", measurementName: "Measurement name", measurementNamePlaceholder: "For example, Waist or 5K time", value: "Value", measurementValuePlaceholder: "For example, 84 or 24:10", unitOptional: "Unit (optional)", measurementUnitPlaceholder: "cm, min, reps…", measurementDate: "Measurement date (month/day/year)", saveMeasurement: "Save measurement", updateMeasurement: "Update measurement", measurementSaved: "Measurement saved.", deleteMeasurement: "Delete measurement", deleteMeasurementEntry: "Delete this value", confirmDeleteMeasurement: "Move this measurement and its history to Trash?", confirmDeleteMeasurementEntry: "Move this dated value to Trash?", typeProgressMetric: "Measurement", typeProgressEntry: "Measurement value", safeComparison: "Safe comparison", compareBackups: "Compare backups", compareBackupsCopy: "Choose two Training Atlas backups, or use your current progress on either side. Nothing is imported or replaced automatically.", earlierSnapshot: "Earlier snapshot", laterSnapshot: "Later snapshot", nothingSelected: "Nothing selected", chooseBackup: "Choose backup", useCurrentProgress: "Use current progress", currentProgress: "Current progress", comparisonWaiting: "Choose both snapshots to start the comparison.", comparisonNoData: "Neither snapshot contains progress information yet.", comparisonInvalidBackup: "Choose a valid Training Atlas backup.", comparisonMeasurementFound: "The later snapshot contains a measurement that is not in the earlier snapshot or your current progress.", comparisonMeasurementMatchCopy: "If this is a renamed or misspelled measurement, choose its earlier equivalent.", chooseMeasurementMatch: "Choose matching measurement", matchAndCompare: "Match & compare", addToMyProgress: "Add as new", compareOnly: "Compare separately", ignore: "Ignore", measurementAddedFromBackup: "Measurement added to your progress.", measurementsMatched: "Measurements matched for this comparison.", comparisonMatchSafeCopy: "Matching only combines rows in this comparison. It does not rename, delete, or import saved measurements.", comparisonField: "Measurement", comparisonEarlier: "Earlier", comparisonLater: "Later", comparisonChange: "Change", comparisonAction: "Action", mergeRows: "Match rows", undoMatch: "Undo match", missingFromSnapshot: "Not in snapshot", noComparableValue: "—", snapshotLoaded: "Snapshot loaded.", compareSummary: "Comparison between {before} and {after}",
    deleteProfile: "Delete profile", confirmDeleteProfile: "Delete the name, height, and weight from this profile? Custom measurements and every other tab will remain.", profileDeleted: "Profile deleted.", manageData: "Manage data", privacyControls: "Privacy controls", manageDataCopy: "Choose exactly which parts of Training Atlas to remove. Export a backup first if you may need this information again.", selectEverything: "Select everything", selectEverythingCopy: "Includes every tab, the profile, Trash, and stored exercise media.", deleteProfileCopy: "Name, height, and weight only.", deleteWorkoutsCopy: "Sports, workouts, exercises, their calendar sessions, images, and videos.", deleteMealsCopy: "Saved meals and their calendar entries.", deleteSupplementsCopy: "Saved supplements and their calendar entries.", deleteCalendarCopy: "All scheduled entries; saved libraries remain.", deleteGoalsCopy: "Every goal and its progress.", deleteMeasurementsCopy: "Every custom measurement and its dated history.", deleteTrashCopy: "Permanently removes items that could otherwise be recovered.", manageDataWarning: "Selected library content is moved to Trash unless Trash is also selected. Profile deletion and an emptied Trash cannot be undone without a backup.", deleteSelectedData: "Delete selected data", chooseDataToDelete: "Choose at least one section to delete.", confirmDeleteSelectedData: "Delete the selected Training Atlas data? Review your selection carefully. Profile data and anything removed from Trash cannot be recovered without a backup.", selectedDataDeleted: "Selected data deleted.",
  ...
  pt: {
    ...
    progress: "Progresso", personalProgress: "Progresso pessoal", progressIntro: "Mantenha o essencial simples, adicione apenas as medições importantes para si e compare cópias guardadas sem substituir nada.", profile: "Perfil", basics: "Dados básicos", editProfile: "Editar perfil", profileOptionalCopy: "Tudo é opcional e permanece apenas neste dispositivo.", nicknameOptional: "Nome ou alcunha (opcional)", heightOptional: "Altura (opcional)", weightOptional: "Peso (opcional)", unit: "Unidade", saveProfile: "Guardar perfil", profileSaved: "Perfil guardado.", profileNotSet: "Adicione apenas os dados básicos que quiser guardar aqui.", notSet: "Não definido", lastUpdated: "Última atualização", fullyCustom: "Totalmente personalizável", myMeasurements: "As minhas medições", newMeasurement: "Nova medição", addMeasurement: "Adicionar medição", addFirstMeasurement: "Adicionar primeira medição", noMeasurements: "Ainda não existem medições", noMeasurementsCopy: "Adicione o que lhe for útil, como peso, cintura, tempo de 5 km, ritmo de natação ou máximo de flexões.", measurement: "Medição", measurementDialogCopy: "Utilize qualquer nome, valor e unidade que faça sentido para o seu desporto ou rotina.", measurementName: "Nome da medição", measurementNamePlaceholder: "Por exemplo, Cintura ou tempo de 5 km", value: "Valor", measurementValuePlaceholder: "Por exemplo, 84 ou 24:10", unitOptional: "Unidade (opcional)", measurementUnitPlaceholder: "cm, min, repetições…", measurementDate: "Data da medição (mês/dia/ano)", saveMeasurement: "Guardar medição", updateMeasurement: "Atualizar medição", measurementSaved: "Medição guardada.", deleteMeasurement: "Eliminar medição", deleteMeasurementEntry: "Eliminar este valor", confirmDeleteMeasurement: "Mover esta medição e o respetivo histórico para o Lixo?", confirmDeleteMeasurementEntry: "Mover este valor com data para o Lixo?", typeProgressMetric: "Medição", typeProgressEntry: "Valor de medição", safeComparison: "Comparação segura", compareBackups: "Comparar cópias", compareBackupsCopy: "Escolha duas cópias do Training Atlas ou utilize o progresso atual num dos lados. Nada é importado ou substituído automaticamente.", earlierSnapshot: "Registo anterior", laterSnapshot: "Registo posterior", nothingSelected: "Nada selecionado", chooseBackup: "Escolher cópia", useCurrentProgress: "Utilizar progresso atual", currentProgress: "Progresso atual", comparisonWaiting: "Escolha os dois registos para iniciar a comparação.", comparisonNoData: "Nenhum dos registos contém ainda informações de progresso.", comparisonInvalidBackup: "Escolha uma cópia válida do Training Atlas.", comparisonMeasurementFound: "O registo posterior contém uma medição que não existe no registo anterior nem no seu progresso atual.", comparisonMeasurementMatchCopy: "Se for uma medição com outro nome ou um erro de escrita, escolha a equivalente no registo anterior.", chooseMeasurementMatch: "Escolher medição correspondente", matchAndCompare: "Associar e comparar", addToMyProgress: "Adicionar como nova", compareOnly: "Comparar separadamente", ignore: "Ignorar", measurementAddedFromBackup: "Medição adicionada ao seu progresso.", measurementsMatched: "Medições associadas nesta comparação.", comparisonMatchSafeCopy: "A associação apenas combina as linhas nesta comparação. Não altera, elimina nem importa medições guardadas.", comparisonField: "Medição", comparisonEarlier: "Anterior", comparisonLater: "Posterior", comparisonChange: "Alteração", comparisonAction: "Ação", mergeRows: "Associar linhas", undoMatch: "Desfazer associação", missingFromSnapshot: "Não existe no registo", noComparableValue: "—", snapshotLoaded: "Registo carregado.", compareSummary: "Comparação entre {before} e {after}",
    deleteProfile: "Eliminar perfil", confirmDeleteProfile: "Eliminar o nome, a altura e o peso deste perfil? As medições personalizadas e todos os outros separadores permanecem.", profileDeleted: "Perfil eliminado.", manageData: "Gerir dados", privacyControls: "Controlos de privacidade", manageDataCopy: "Escolha exatamente que partes do Training Atlas pretende remover. Exporte primeiro uma cópia se puder precisar destes dados novamente.", selectEverything: "Selecionar tudo", selectEverythingCopy: "Inclui todos os separadores, o perfil, o Lixo e os ficheiros multimédia dos exercícios.", deleteProfileCopy: "Apenas o nome, a altura e o peso.", deleteWorkoutsCopy: "Desportos, treinos, exercícios, sessões no calendário, imagens e vídeos.", deleteMealsCopy: "Refeições guardadas e respetivas entradas no calendário.", deleteSupplementsCopy: "Suplementos guardados e respetivas entradas no calendário.", deleteCalendarCopy: "Todas as entradas agendadas; as bibliotecas permanecem.", deleteGoalsCopy: "Todos os objetivos e o respetivo progresso.", deleteMeasurementsCopy: "Todas as medições personalizadas e o respetivo histórico.", deleteTrashCopy: "Remove permanentemente itens que ainda poderiam ser recuperados.", manageDataWarning: "O conteúdo selecionado das bibliotecas é movido para o Lixo, exceto se o Lixo também estiver selecionado. A eliminação do perfil e o esvaziamento do Lixo não podem ser anulados sem uma cópia.", deleteSelectedData: "Eliminar dados selecionados", chooseDataToDelete: "Escolha pelo menos uma secção para eliminar.", confirmDeleteSelectedData: "Eliminar os dados selecionados do Training Atlas? Reveja cuidadosamente a seleção. Os dados do perfil e tudo o que for removido do Lixo não podem ser recuperados sem uma cópia.", selectedDataDeleted: "Dados selecionados eliminados.",
...
let progressComparison = { before: null, after: null, decisions: {}, matches: {} };
...
function renderSupplements() {
  ...
  for (const supplement of state.supplements) {
    ...
    const currentSchedule = recurringSupplementSchedule(supplement.id);
    actions.append(createActionButton(t(currentSchedule ? "editRecurringSchedule" : "scheduleSupplement"),"calendar","schedule-supplement",supplement.id),createActionButton(t("editSupplement"),"✎","edit-supplement",supplement.id),createActionButton(t("duplicateSupplement"),"⧉","duplicate-supplement",supplement.id),createActionButton(t("deleteSupplement"),"×","delete-supplement",supplement.id,"danger"));
    header.append(copy,actions); card.append(header);
...
function progressMatchKey(metric) {
  return progressMetricKey(metric).normalize("NFD").replace(/[\u0300-\u036f]/g,"").replace(/[^a-z0-9]/g,"");
}

function editDistance(left,right) {
  const a = progressMatchKey(left); const b = progressMatchKey(right);
  const row = Array.from({ length:b.length + 1 },(_,index) => index);
  for (let i = 1; i <= a.length; i += 1) {
    let previous = row[0]; row[0] = i;
    for (let j = 1; j <= b.length; j += 1) {
      const above = row[j]; row[j] = Math.min(row[j] + 1,row[j - 1] + 1,previous + (a[i - 1] === b[j - 1] ? 0 : 1)); previous = above;
    }
  }
  return row[b.length];
}

function sortMatchCandidates(metrics,target) {
  return [...metrics].sort((left,right) => editDistance(left,target) - editDistance(right,target) || left.label.localeCompare(right.label,dateLocale()));
}

function matchedBeforeMetric(afterMetric) {
  const beforeId = progressComparison.matches[afterMetric?.id];
  return progressComparison.before?.metrics.find((metric) => metric.id === beforeId) || null;
}

function matchedAfterMetric(beforeMetric) {
  const afterId = Object.entries(progressComparison.matches).find(([,beforeId]) => beforeId === beforeMetric?.id)?.[0];
  return progressComparison.after?.metrics.find((metric) => metric.id === afterId) || null;
}

function availableBeforeMatches(afterMetric) {
  const used = new Set(Object.values(progressComparison.matches));
  return sortMatchCandidates((progressComparison.before?.metrics || []).filter((metric) => !used.has(metric.id) && !findProgressMetric([metric],afterMetric)),afterMetric);
}

function availableAfterMatches(beforeMetric) {
  const used = new Set(Object.keys(progressComparison.matches));
  return sortMatchCandidates((progressComparison.after?.metrics || []).filter((metric) => !used.has(metric.id) && !findProgressMetric([beforeMetric],metric)),beforeMetric);
}

function appendMatchOptions(select,metrics) {
  const placeholder = document.createElement("option"); placeholder.value = ""; placeholder.textContent = t("chooseMeasurementMatch"); select.append(placeholder);
  for (const metric of metrics) {
    const option = document.createElement("option"); const latest = latestProgressEntry(metric); option.value = metric.id; option.textContent = latest ? `${metric.label} · ${progressValue(latest.value,latest.unit || metric.unit)}` : metric.label; select.append(option);
  }
}
...
function comparisonRow(label,beforeValue,beforeUnit,afterValue,afterUnit,metadata = {}) {
  ...
  return { label, before: beforeValue ? progressValue(beforeValue,beforeUnit) : t("missingFromSnapshot"), after: afterValue ? progressValue(afterValue,afterUnit) : t("missingFromSnapshot"), delta, ...metadata };
}
...
function renderProgressComparison() {
  ...
  for (const metric of after.metrics) {
    ...
    const candidates = availableBeforeMatches(metric);
    if (candidates.length) {
      const match = document.createElement("div"); match.className = "comparison-prompt-match";
      const hint = document.createElement("p"); hint.textContent = t("comparisonMeasurementMatchCopy");
      const controls = document.createElement("div"); const select = document.createElement("select"); select.setAttribute("aria-label",t("chooseMeasurementMatch")); appendMatchOptions(select,candidates);
      const button = document.createElement("button"); button.type = "button"; button.className = "button secondary"; button.dataset.action = "match-comparison-prompt"; button.dataset.id = metric.id; button.textContent = t("matchAndCompare"); button.disabled = true; select.addEventListener("change",() => { button.disabled = !select.value; });
      controls.append(select,button); match.append(hint,controls); copy.append(match);
    }
  ...
  for (const metric of after.metrics) {
    const linked = matchedBeforeMetric(metric); const earlier = linked || findProgressMetric(before.metrics,metric); const current = findProgressMetric(state.progressMetrics,metric); const decision = progressComparison.decisions[metric.id];
    ...
    const label = linked && progressMetricKey(linked) !== progressMetricKey(metric) ? `${linked.label} ↔ ${metric.label}` : metric.label;
    rows.push(comparisonRow(label,earlierEntry?.value,earlierEntry?.unit || earlier?.unit || metric.unit,laterEntry?.value,laterEntry?.unit || metric.unit,{ beforeMetric:earlier || null, afterMetric:metric, matched:Boolean(linked) }));
  }
  for (const metric of before.metrics) {
    if (findProgressMetric(after.metrics,metric) || matchedAfterMetric(metric)) continue;
    const earlierEntry = latestProgressEntry(metric); rows.push(comparisonRow(metric.label,earlierEntry?.value,earlierEntry?.unit || metric.unit,"",metric.unit,{ beforeMetric:metric, afterMetric:null, matched:false }));
  }
  if (!rows.length) return;
  const matchNote = document.createElement("p"); matchNote.className = "comparison-match-note"; matchNote.textContent = t("comparisonMatchSafeCopy"); elements.comparisonResults.append(matchNote);
  ...
  for (const label of [t("comparisonField"),t("comparisonEarlier"),t("comparisonLater"),t("comparisonChange"),t("comparisonAction")]) { const cell = document.createElement("th"); cell.scope = "col"; cell.textContent = label; headerRow.append(cell); }
  head.append(headerRow); const body = document.createElement("tbody");
  for (const row of rows) {
    const tr = document.createElement("tr"); for (const value of [row.label,row.before,row.after]) { const td = document.createElement("td"); td.textContent = value; tr.append(td); }
    const change = document.createElement("td"); change.className = `comparison-change ${row.delta.className}`.trim(); change.textContent = row.delta.text; tr.append(change);
    const action = document.createElement("td"); action.className = "comparison-row-action";
    if (row.matched) {
      const undo = document.createElement("button"); undo.type = "button"; undo.className = "table-action-button"; undo.dataset.action = "unmatch-comparison-rows"; undo.dataset.id = row.afterMetric.id; undo.textContent = t("undoMatch"); action.append(undo);
    } else if (row.afterMetric && !row.beforeMetric) {
      const candidates = availableBeforeMatches(row.afterMetric);
      if (candidates.length) {
        const select = document.createElement("select"); select.setAttribute("aria-label",t("chooseMeasurementMatch")); appendMatchOptions(select,candidates);
        const merge = document.createElement("button"); merge.type = "button"; merge.className = "table-action-button"; merge.dataset.action = "match-comparison-rows"; merge.dataset.afterId = row.afterMetric.id; merge.textContent = t("mergeRows"); merge.disabled = true; select.addEventListener("change",() => { merge.disabled = !select.value; }); action.append(select,merge);
      }
    } else if (row.beforeMetric && !row.afterMetric) {
      const candidates = availableAfterMatches(row.beforeMetric);
      if (candidates.length) {
        const select = document.createElement("select"); select.setAttribute("aria-label",t("chooseMeasurementMatch")); appendMatchOptions(select,candidates);
        const merge = document.createElement("button"); merge.type = "button"; merge.className = "table-action-button"; merge.dataset.action = "match-comparison-rows"; merge.dataset.beforeId = row.beforeMetric.id; merge.textContent = t("mergeRows"); merge.disabled = true; select.addEventListener("change",() => { merge.disabled = !select.value; }); action.append(select,merge);
      }
    }
    if (!action.children.length) action.textContent = t("noComparableValue"); tr.append(action); body.append(tr);
  }
...
function renderAgenda() {
  ...
  for (const entry of items) {
    ...
    if (calendarItem.seriesId) { const recurring = document.createElement("span"); recurring.className = "recurring-label"; recurring.textContent = t("recurring"); content.append(recurring); }
...
function setupRecurrenceForm(form, dateFieldName) {
  const dateInput = form.elements[dateFieldName];
  if (!dateInput || form.querySelector(".recurrence-controls")) return;
  const controls = document.createElement("fieldset"); controls.className = "recurrence-controls"; controls.dataset.dateField = dateFieldName;
  const legend = recurrenceTextNode("legend","repeatSchedule");
  const modeLabel = document.createElement("label"); modeLabel.append(recurrenceTextNode("span","recurrenceMode"));
  const mode = document.createElement("select"); mode.name = "recurrenceMode";
  for (const [value,key] of [["once","once"],["daily","daily"],["interval","everyXDays"],["weekdays","customDays"]]) {
  ...
  intervalRow.append(intervalInput,recurrenceTextNode("span","daysUnit")); interval.append(intervalRow);
  const until = document.createElement("label"); until.className = "recurrence-until"; until.append(recurrenceTextNode("span","repeatUntil"));
  const untilInput = document.createElement("input"); untilInput.name = "repeatUntil"; untilInput.type = "date"; until.append(untilInput);
  const weekdays = document.createElement("div"); weekdays.className = "recurrence-weekdays"; weekdays.append(recurrenceTextNode("span","chooseDays"));
  const picker = document.createElement("div"); picker.className = "weekday-picker";
  for (const [value,key] of [[1,"mondayShort"],[2,"tuesdayShort"],[3,"wednesdayShort"],[4,"thursdayShort"],[5,"fridayShort"],[6,"saturdayShort"],[7,"sundayShort"]]) {
    const label = document.createElement("label"); const input = document.createElement("input"); input.type = "checkbox"; input.name = "recurrenceWeekday"; input.value = String(value); label.append(input,recurrenceTextNode("span",key)); picker.append(label);
  }
...
function updateRecurrenceControls(form) {
  ...
  if (mode !== "once" && !form.elements.repeatUntil.value) {
    const start = parseIsoDate(form.elements[controls.dataset.dateField]?.value || selectedDate);
    form.elements.repeatUntil.value = toLocalIso(addDays(start,28));
  }
}
...
function recurringSupplementSchedule(supplementId) {
  const today = toLocalIso(new Date());
  const active = state.supplementEntries.filter((item) => item.supplementId === supplementId && item.seriesId && !item.completed && item.date >= today);
  if (!active.length) return null;
  const groups = new Map();
  for (const entry of active) {
    if (!groups.has(entry.seriesId)) groups.set(entry.seriesId,[]);
    groups.get(entry.seriesId).push(entry);
  }
  const newest = [...groups.values()].sort((first,second) => {
    const firstTime = Math.max(...first.map((item) => Date.parse(item.createdAt) || 0));
    const secondTime = Math.max(...second.map((item) => Date.parse(item.createdAt) || 0));
    return secondTime - firstTime;
  })[0];
  const entry = [...newest].sort((first,second) => first.date.localeCompare(second.date) || first.createdAt.localeCompare(second.createdAt))[0];
  return { entry, seriesIds: [...groups.keys()] };
}
...
function recurrenceDates(form, dateFieldName) {
...
function recurringToast(count, fallbackKey = "sessionSaved") {
  return count > 1 ? t("recurringEntriesCreated").replace("{count}",String(count)) : t(fallbackKey);
}
...
function openWorkoutDialog(workout = null) {
  ...
  resetRecurrenceForm(elements.workoutForm,Boolean(workout));
...
function updateNewWorkoutSchedule() {
  ...
  elements.workoutForm.querySelector(".recurrence-controls").hidden = !enabled;
...
function openMealDialog(meal = null) {
  ...
  resetRecurrenceForm(elements.mealForm,Boolean(meal));
...
function updateNewMealSchedule() {
  ...
  elements.mealForm.querySelector(".recurrence-controls").hidden = !enabled;
...
function openSupplementDialog(supplement = null) {
  ...
  resetRecurrenceForm(elements.supplementForm,Boolean(supplement));
...
function updateNewSupplementSchedule() {
  ...
  elements.supplementForm.querySelector(".recurrence-controls").hidden = !enabled;
...
function openSupplementScheduleDialog(entry = null, supplementId = null, replaceSeriesIds = []) {
  ...
  elements.supplementScheduleDialog.dataset.replaceSeriesIds = replaceSeriesIds.join(",");
...
function openPlannerDialog() {
  ...
  resetRecurrenceForm(elements.plannerForm,false);
...
function handlePlannerSubmit(event) {
  ...
  const form = elements.plannerForm;
  const recurrence = recurrenceDates(form,"date"); if (!recurrence) return;
  const drafts = [];
  ...
  const scheduledCount = addRecurringEntries(state.sessions,recurrence,(date,seriesId,createdAt) => ({ id: id(), sportId: sport.id, workoutId: workout.id, date, notes: clean(form.elements.sessionNotes.value,500), completed: false, seriesId, plannerCreatedWorkout, plannerCreatedSport, createdAt }));
  selectedSportId = sport.id; selectedWorkoutId = workout.id; selectedDate = recurrence.dates[0]; calendarMonth = startOfMonth(parseIsoDate(selectedDate)); activeView = "calendar";
  saveState(); elements.plannerDialog.close(); render(); showToast(scheduledCount > 1 ? t("recurringPlanSaved").replace("{count}",String(scheduledCount)) : t("planSaved"));
}
...
function handleWorkoutSubmit(event) {
  ...
  const shouldSchedule = !existing && values.scheduleEnabled === "on";
  const recurrence = shouldSchedule ? recurrenceDates(elements.workoutForm,"scheduleDate") : null;
  if (shouldSchedule && !recurrence) return;
  ...
  if (existing) Object.assign(existing, { name: clean(values.name,80), description: clean(values.description,500), duration: clean(values.duration,40), notes: clean(values.notes,200) });
    ...
    if (recurrence) {
      scheduledCount = addRecurringEntries(state.sessions,recurrence,(date,seriesId,createdAt) => ({ id: id(), sportId: selectedSportId, workoutId: workout.id, date, notes: "", completed: false, seriesId, plannerCreatedWorkout: true, plannerCreatedSport: false, createdAt }));
      selectedDate = recurrence.dates[0]; calendarMonth = startOfMonth(parseIsoDate(selectedDate));
    }
  }
  saveState(); elements.workoutDialog.close(); render(); showToast(scheduledCount ? recurringToast(scheduledCount,"workoutSavedAndScheduled") : t("workoutSaved"));
}
...
function handleMealSubmit(event) {
  ...
  const shouldSchedule = !existing && values.scheduleEnabled === "on";
  const recurrence = shouldSchedule ? recurrenceDates(elements.mealForm,"scheduleDate") : null;
  if (shouldSchedule && !recurrence) return;
  let scheduledCount = 0;
  if (existing) Object.assign(existing,fields);
    ...
    if (recurrence) {
      scheduledCount = addRecurringEntries(state.mealEntries,recurrence,(date,seriesId,createdAt) => ({ id: id(), mealId: meal.id, date, notes: "", completed: false, seriesId, createdAt }));
      selectedDate = recurrence.dates[0]; calendarMonth = startOfMonth(parseIsoDate(selectedDate));
    }
  }
  saveState(); elements.mealDialog.close(); render(); showToast(scheduledCount ? recurringToast(scheduledCount,"mealSavedAndScheduled") : t("mealSaved"));
}
...
function handleSupplementSubmit(event) {
  ...
  const shouldSchedule = !existing && values.scheduleEnabled === "on";
  const recurrence = shouldSchedule ? recurrenceDates(elements.supplementForm,"scheduleDate") : null;
  if (shouldSchedule && !recurrence) return;
  let scheduledCount = 0;
  if (existing) Object.assign(existing,fields);
  else {
    ...
    if (recurrence) {
      scheduledCount = addRecurringEntries(state.supplementEntries,recurrence,(date,seriesId,createdAt) => ({ id: id(), supplementId: supplement.id, date, notes: "", completed: false, seriesId, createdAt }));
      selectedDate = recurrence.dates[0]; calendarMonth = startOfMonth(parseIsoDate(selectedDate));
    }
  }
  saveState(); elements.supplementDialog.close(); render(); showToast(scheduledCount ? recurringToast(scheduledCount,"supplementSavedAndScheduled") : t("supplementSaved"));
}
...
function handleSupplementScheduleSubmit(event) {
  ...
  if (existing && !existing.seriesId && recurrence.dates.length === 1) { Object.assign(existing,fields,{ seriesId: "", recurrence: null }); selectedDate = values.date; }
    ...
    const replaceSeriesIds = new Set((elements.supplementScheduleDialog.dataset.replaceSeriesIds || "").split(",").filter(Boolean));
    if (replaceSeriesIds.size > 1) {
      state.supplementEntries = state.supplementEntries.filter((item) => item.seriesId === existing.seriesId || !replaceSeriesIds.has(item.seriesId) || item.completed);
    }
...
function deleteProgressProfile() {
  if (!confirm(t("confirmDeleteProfile"))) return;
  state.progressProfile = emptyProgressProfile(); progressComparison = { before:null, after:null, decisions:{}, matches:{} };
  saveState(); renderProgress(); showToast(t("profileDeleted"));
}

function selectedDataSections() {
  return new Set($$('input[name="dataSection"]',elements.dataForm).filter((input) => input.checked).map((input) => input.value));
}

function updateDataSelection() {
  const checkboxes = $$('input[name="dataSection"]',elements.dataForm); const checked = checkboxes.filter((input) => input.checked).length;
  elements.dataSelectAll.checked = checked === checkboxes.length; elements.dataSelectAll.indeterminate = checked > 0 && checked < checkboxes.length; elements.deleteSelectedData.disabled = checked === 0;
}

function openDataDialog() {
  elements.dataForm.reset(); elements.dataSelectAll.indeterminate = false; updateDataSelection(); elements.dataDialog.showModal();
}

async function handleDataSubmit(event) {
  event.preventDefault(); const sections = selectedDataSections();
  if (!sections.size) { showToast(t("chooseDataToDelete"),true); return; }
  if (!confirm(t("confirmDeleteSelectedData"))) return;
  if (sections.has("workouts")) {
    for (const sport of [...state.sports]) trashSport(sport.id);
  }
  if (sections.has("meals")) for (const meal of [...state.meals]) trashMeal(meal.id);
  if (sections.has("supplements")) for (const supplement of [...state.supplements]) trashSupplement(supplement.id);
  if (sections.has("calendar")) {
    for (const session of [...state.sessions]) trashSession(session.id);
    for (const entry of [...state.mealEntries]) trashMealEntry(entry.id);
    for (const entry of [...state.supplementEntries]) trashSupplementEntry(entry.id);
  }
  if (sections.has("goals")) for (const goal of [...state.goals]) trashGoal(goal.id);
  if (sections.has("measurements")) for (const metric of [...state.progressMetrics]) trashProgressMetric(metric.id);
  if (sections.has("profile")) state.progressProfile = emptyProgressProfile();
  if (sections.has("trash")) state.trash = [];
  if (sections.has("profile") || sections.has("measurements")) progressComparison = { before:null, after:null, decisions:{}, matches:{} };
  if (sections.has("trash")) await cleanupOrphanMedia();
  saveState(); elements.dataDialog.close(); render(); showToast(t("selectedDataDeleted"));
}
...
function trashSupplementEntries(entryIds) {
  const ids = new Set(entryIds);
  const entries = state.supplementEntries.filter((item) => ids.has(item.id));
  if (!entries.length) return 0;
  if (entries.length === 1) return trashSupplementEntry(entries[0].id) ? 1 : 0;
  const supplement = state.supplements.find((item) => item.id === entries[0].supplementId);
  const label = `${supplement?.name || t("typeSupplementEntry")} · ${plural(entries.length,"supplementEntrySingular","supplementEntryPlural")}`;
  addTrashItem("supplementEntry",label,{ supplement, supplementEntry: entries[0], supplementEntries: entries });
  state.supplementEntries = state.supplementEntries.filter((item) => !ids.has(item.id));
  return entries.length;
}

function openSupplementRemovalDialog(entryId) {
  const entry = state.supplementEntries.find((item) => item.id === entryId); if (!entry) return;
  const future = entry.seriesId ? state.supplementEntries.filter((item) => item.seriesId === entry.seriesId && item.date >= entry.date) : [entry];
  const sameDay = future.filter((item) => item.date === entry.date);
  if (!entry.seriesId || future.length <= sameDay.length) {
    if (!confirm(t("confirmDeleteSupplementEntry"))) return;
    if (trashSupplementEntries(sameDay.map((item) => item.id))) { saveState(); render(); showToast(t("movedToTrash")); }
    return;
  }
  elements.supplementRemoveDialog.dataset.entryId = entry.id;
  elements.supplementRemoveDialog.showModal();
}

function confirmSupplementRemoval(scope) {
  const entryId = elements.supplementRemoveDialog.dataset.entryId || "";
  const entry = state.supplementEntries.find((item) => item.id === entryId); if (!entry) { elements.supplementRemoveDialog.close(); return; }
  const entries = state.supplementEntries.filter((item) => item.seriesId === entry.seriesId && (scope === "future" ? item.date >= entry.date : item.date === entry.date));
  const removed = trashSupplementEntries(entries.map((item) => item.id));
  elements.supplementRemoveDialog.close();
  if (removed) { saveState(); render(); showToast(t("movedToTrash")); }
}
...
function restoreTrashItem(entryId) {
  ...
  if (entry.type === "supplementEntry") {
    const supplementEntries = entry.payload.supplementEntries?.length ? entry.payload.supplementEntries : [entry.payload.supplementEntry].filter(Boolean);
    const supplementEntry = supplementEntries[0];
    restored = Boolean(supplementEntry && restoreSupplementById(supplementEntry.supplementId,entry.payload));
    if (restored) { for (const item of supplementEntries) pushUnique(state.supplementEntries,item); removeTrashEntry(entry.id); }
  }
  if (entry.type === "media") {
...
async function handleAction(action, target) {
  ...
  if (action === "match-comparison-prompt") { const beforeId = target.closest(".comparison-prompt")?.querySelector("select")?.value; matchComparisonMetrics(itemId,beforeId); return; }
  if (action === "match-comparison-rows") { const selectedId = target.closest("tr")?.querySelector("select")?.value; matchComparisonMetrics(target.dataset.afterId || selectedId,target.dataset.beforeId || selectedId); return; }
  if (action === "unmatch-comparison-rows") { unmatchComparisonMetric(itemId); return; }
  ...
  if (action === "schedule-supplement") {
    const current = itemId ? recurringSupplementSchedule(itemId) : null;
    return openSupplementScheduleDialog(current?.entry || null,itemId,current?.seriesIds || []);
  }
  if (action === "confirm-supplement-removal") return confirmSupplementRemoval(target.dataset.scope);
...
async function loadComparisonBackup(file,side) {
  ...
  try {
    ...
    progressComparison[side] = progressSnapshot(file.name,payload.library,payload.exportedAt || ""); progressComparison.decisions = {}; progressComparison.matches = {};
...
function useCurrentComparison(side) {
  ...
  progressComparison[side] = progressSnapshot(t("currentProgress"),state,now()); progressComparison.decisions = {}; progressComparison.matches = {}; renderProgressComparison();
}

function matchComparisonMetrics(afterId,beforeId) {
  const afterMetric = progressComparison.after?.metrics.find((metric) => metric.id === afterId); const beforeMetric = progressComparison.before?.metrics.find((metric) => metric.id === beforeId);
  if (!afterMetric || !beforeMetric) return;
  for (const [otherAfterId,otherBeforeId] of Object.entries(progressComparison.matches)) if (otherAfterId === afterId || otherBeforeId === beforeId) { delete progressComparison.matches[otherAfterId]; delete progressComparison.decisions[otherAfterId]; }
  progressComparison.matches[afterId] = beforeId; progressComparison.decisions[afterId] = "match"; renderProgressComparison(); showToast(t("measurementsMatched"));
}

function unmatchComparisonMetric(afterId) {
  if (!progressComparison.matches[afterId]) return;
  delete progressComparison.matches[afterId]; delete progressComparison.decisions[afterId]; renderProgressComparison();
}
...
elements.dataSelectAll.addEventListener("change",() => { for (const input of $$('input[name="dataSection"]',elements.dataForm)) input.checked = elements.dataSelectAll.checked; updateDataSelection(); });
elements.dataForm.addEventListener("change",(event) => { if (event.target.name === "dataSection") updateDataSelection(); });
...
for (const [form,dateField] of [[elements.workoutForm,"scheduleDate"],[elements.mealForm,"scheduleDate"],[elements.supplementForm,"scheduleDate"],[elements.scheduleForm,"date"],[elements.mealScheduleForm,"date"],[elements.supplementScheduleForm,"date"],[elements.plannerForm,"date"]]) setupRecurrenceForm(form,dateField);
