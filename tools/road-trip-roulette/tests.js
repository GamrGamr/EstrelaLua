...
test("Mini-plan Google link combines the exact name and anchor", () => { const url = googlePlaceUrl(stopMapQueries.arrabida[2], stopMapPoints.arrabida[2], "en"); assert(url.includes("Portinho%20da%20Arr%C3%A1bida")); assert(url.includes("/@38.475355,-8.98436,17z")); });
