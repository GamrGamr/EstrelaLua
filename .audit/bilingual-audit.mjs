...
check("Training Atlas goals are included in backups and recoverable trash", trainingAtlasScript.includes("goals: []") && trainingAtlasScript.includes('version: 4, exportedAt') && trainingAtlasScript.includes('addTrashItem("goal"') && trainingAtlasScript.includes('entry.type === "goal"') && trainingAtlasScript.includes("sanitiseGoal"));
