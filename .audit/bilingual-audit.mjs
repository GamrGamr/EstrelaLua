...
check("Training Atlas can delete only the profile or selected data sections", trainingAtlasHtml.includes('data-action="delete-progress-profile"') && trainingAtlasHtml.includes('id="data-dialog"') && trainingAtlasHtml.includes('name="dataSection" value="workouts"') && trainingAtlasHtml.includes('name="dataSection" value="trash"') && trainingAtlasScript.includes("deleteProgressProfile") && trainingAtlasScript.includes("handleDataSubmit") && trainingAtlasScript.includes("selectedDataSections") && trainingAtlasScript.includes("confirmDeleteSelectedData"));
